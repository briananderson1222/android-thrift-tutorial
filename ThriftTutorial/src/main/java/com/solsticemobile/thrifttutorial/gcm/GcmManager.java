...
public class GcmManager {
    ...
    final static String TAG = "GcmManager";
    /**
     * Substitute you own sender ID here. This is the project number you got
     * from the API Console, as described in "Getting Started."
     */

    final static String SENDER_ID = "954579491697";
    ...
    public void setupForPlayServices(Activity activity, String token) {
    ...
    private SharedPreferences getGCMPreferences(Context context) {
        ...
        return context.getSharedPreferences("MainActivity",
    ...
    private void sendRegistrationIdToBackend() {
        try {
            SampleThriftClient.getChatClient().registerAndroidToken(regId, chatToken);
        } catch (Exception e) {
            Log.d(TAG, "Failed when registering Android token");
        }
    }
